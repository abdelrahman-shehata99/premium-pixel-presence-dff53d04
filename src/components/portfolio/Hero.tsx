...
export function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative h-[100svh] min-h-[600px] flex flex-col justify-center overflow-hidden"
    >
      ...
      >
        ...
        >
          I build and scale production Flutter apps — including iStoria, serving 5M+ users — with a
          focus on performance, clean architecture, and AI-powered personalization.
        </motion.p>
        ...
        <motion.div variants={item} className="mt-10 flex items-center gap-5">
          ...
          <span className="ml-2 inline-flex items-center gap-1.5 text-xs font-mono-ui text-muted-foreground border border-border rounded-full px-3 py-1">
