    ...
    <section id="experience" className="py-20 sm:py-28">
      <div className="mx-auto max-w-[1140px] px-5 sm:px-8">
        ...
        <Stagger className="relative">
          {/* timeline line */}
          <div aria-hidden className="absolute left-3 sm:left-4 top-2 bottom-2 w-px bg-border" />
                ...
                <article className="group rounded-2xl border border-border bg-card p-6 sm:p-8 hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-lg transition-all">
                  <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-4 sm:flex sm:flex-wrap sm:justify-between">
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-semibold tracking-tight">{r.role}</h3>
