            ...
            <div className="grid lg:grid-cols-[1.1fr_0.9fr]">
              <div className="p-8 sm:p-12 flex flex-col">
                ...
                <p className="mt-4 text-muted-foreground leading-relaxed">
                  Led Flutter delivery, built a reusable component &amp; animation system, and
                  integrated AI-powered personalization and recommendations. Standardized the UI
                  across the app and shipped features with measurable retention impact.
                </p>
